<script>
  ...
  $sectionTitle= 'DOMUS | San patricio - Apartamento Tipo 2 - Tu nuevo hogar';
</script>
...
<section id="tour" class="container-fluid p-0 tour">
  ...
  <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="../../views-360/tipo-2/index.htm" allowfullscreen></iframe>
  </div>  
</section>
...
<section id="more-info" class="container pt-4 pt-md-5 pb-3">
  <div class="row align-items-center">
    <div class="col-sm-12 col-md-5 py-2 px-2">
      ...
      <p class="h5">12 aparta estudios de 36.98 mts<sup>2</sup> ubicados equitativamente en las dos torres del segundo al cuarto piso.</p>
    </div>
    ...
    <div class="col-12 py-2 px-2">
      <h3 class="textfirstimage font-weight-bold pb-3">disfrutar de una unidad tipo dos es tenerlo todo, diseño, comodidad e innovación</h3>
      <img class="img-fluid" src="<?php echo $base_url ?>/assets/stills/tipo2/Comply2.jpg" alt="Lobby">
    </div>
    <div class="col-12 col-md-6 py-2 px-2">
      <img class="img-fluid" src="<?php echo $base_url ?>/assets/stills/tipo2/Tv1.jpg" alt="Lobby">
    </div>
    <div class="col-12 col-md-6 py-2 px-2">
      <img class="img-fluid" src="<?php echo $base_url ?>/assets/stills/tipo2/Tv2.jpg" alt="Sala de juntas">
    </div>
    ...
    <div class="col-12 py-2 px-2">
      <img class="img-fluid" src="<?php echo $base_url ?>/assets/stills/tipo2/Comply3.jpg" alt="Sala de juntas">
      <h3 class="textsecondimage font-weight-bold pt-3">el sueño de tener una propiedad de lujo estará a tu alcance.</h3>
    </div>
  </div>
</section>
    ...
    <div class="col-sm-12 inner-block">
      <div class="row">
        ...
        <div class="col-12 col-xl-8">
          <p class="text-center">
            <small>Precio</small> <small class="d-inline">Desde </small>$369'662.000<sup>cop</sup> <br> <small class="d-inline">Hasta </small> $376'896.000<sup>cop</sup>
          </p>
        </div>
        <div class="col-12 col-xl-4">
          <p class="text-center">
            <small>Área construida</small>36.98mts<sup>2</sup>
          </p>
        </div>
        <div class="col-12 col-xl-4">
          <p>      
      ...
      <div class="modal-content w-75">
        ...
        <div class="modal-body">
          ...
          <div class="row px-5 py-4">
            <div class="col">
              <h2><i class="icon-Web-Icons_Detalles-Apartamento mr-2"></i><span>Apartamento Tipo 2</span></h2>
