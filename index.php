<script> 
    $section = 'home-web';  
    $sectionTitle= 'DOMUS | San patricio'; 
</script>
...
<section id="home-carousel">
    <div id="carouselExampleIndicatorsHero" class="carousel slide" data-ride="carousel">
        <!-- Indicators -->
        <ol class="carousel-indicators">
            <li data-target="#carouselExampleIndicatorsHero" data-slide-to="0" class="active"></li>
            <li data-target="#carouselExampleIndicatorsHero" data-slide-to="1"></li>
        ...
        <!-- Controls -->
        <a class="carousel-control-prev" href="#carouselExampleIndicatorsHero" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"><</span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#carouselExampleIndicatorsHero" role="button" data-slide="next">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <p class="text-justify text-type-02">
                                Estás a poco de tener tu propio espacio en<br><span>DOMUS San Patricio</span>
                            </p>
                        </div>
                    </div>
        ...
        <div id="ubicacion" class="container">
            <div class="row p-0 pt-md-5 align-items-center">
                ...
                <div class="col-12 col-md-3 text-right">
                        ...
                        <a href="#home-carousel" class="btn btn_cita text-light w-50 text-right">Agenda tu cita</a>
                </div>
            </div>
        </div>
    </div>
