...
<section id="tour" class="container-fluid p-0 tour">
  ...
  <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="../../views-360/teatrino/index.htm" allowfullscreen></iframe>
  </div>  
</section>
...
<section id="more-info" class="container pt-5">
  <div class="row align-items-center">
    <div class="col-sm-4">
      ...
      <h1><span>teatrino</span></h1>
    </div>
    <div class="col-sm-8">
      <img class="img-fluid" src="<?php echo $base_url ?>/assets/zonas_comunes/Teatrino.jpg" alt="Coworking">
