...
<section id="tour" class="container-fluid p-0 tour">
  ...
  <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="../../views-360/ping-pong/index.htm" allowfullscreen></iframe>
  </div>  
</section>
...
<!--       <button type="button" class="gallery-access-button open" data-toggle="modal" data-target="#popUpGallery">
    ...
    <div class="col-12 py-3">
      ...
      <img class="img-fluid" src="<?php echo $base_url ?>/assets/zonas_comunes/Gym.jpg" alt="Lobby">
